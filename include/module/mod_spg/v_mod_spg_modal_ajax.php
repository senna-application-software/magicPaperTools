        ...
        <div class='form-group'>
              ...
              $dt .= "
				...
				<div class='modal-footer'>
					<button type='submit' name='create' id='next_spg_edit'  modact='../modact/spg.avx'  class='btn btn-primary'>Save</button>
  ...
  $no_surat = $kd_baru . "/MSO-DIV/SPS/" . $roman . "/" . date("Y"); 
		$dt =  "
			<div class='form-horizontal'>		
				...
				<div class='form-group'>
					<label class='control-label col-sm-3' for='status_spg'>Status</label>
					<div class='col-sm-9'>
						<select name='status_spg' id='status_spg' class='form-control' style='width:100%' disabled>
							<option value='aktif'>AKTIF</option>
							<option value='tidak'>TIDAK</option>
						</select>
					</div>
        ...
        <div class='form-group'>
              ...
              $dt .= "
				...
				<div class='modal-footer'>
					<button type='submit' name='create' id='next_spg_baru'  modact='../modact/spg.avx'  class='btn btn-primary'>Save</button>
					<button type='button' class='btn btn-default' data-dismiss='modal'>Close</button>
				</div>			
			</div>
		";	
...
/**
* End of file v_mod_spg_modal_ajax.php
* Location: ../mod_spg/v_mod_spg_modal_ajax.php
*/