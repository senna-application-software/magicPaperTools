<?php 
	...
	$field2 			= 'jenis';
	$object_data 	= array();
	$object_data2	= $generates->read_fetch($tabel2,$field2,$parameter2='retur');  
          ...
          <div class='text-left row'>
						<table class='table no-wrap tb-head'>
							<tr>
								...
								<td style='width:2%'> : </td>
								<td style='width:1%'> </td>
								<td style='width:82%'>Informasi Retur Barang</td>
							</tr>		
							<tr>
        ...
        echo "
          <div class='text-center'>
            ...
            <h5>No: " . strtoupper($object_data[$i][0]['no_surat']) . "</h5>
				...
				// paragraf 1
				echo "<p>";
				echo $object_data2['header'];
				echo " yang ada di ";
				echo $nm_ctr['nama_konter'];
				echo ", maka dengan ini kami menugaskan ";
				echo $object_data[$i][0]['ekspedisi'];     
				echo " untuk mengambil barang yang dimaksud.";     
				echo "</p>";				
				// paragraf 2
				echo "<br/>";
				echo "<p>";
				echo $object_data2['body'];
				echo strtoupper( ' ' . $data['alamat'] . ' - ' . $data['kota'] . '.');
				echo "</p>";
